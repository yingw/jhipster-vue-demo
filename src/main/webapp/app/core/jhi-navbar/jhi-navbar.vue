        ...
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/entity/region" class="dropdown-item" v-on:click="collapseNavbar()">
                    <font-awesome-icon icon="asterisk" />
                    <span v-text="$t('global.menu.entities.region')">Region</span>
              </b-dropdown-item>
                    <b-dropdown-item to="/entity/country" class="dropdown-item" v-on:click="collapseNavbar()">
                    <font-awesome-icon icon="asterisk" />
                    <span v-text="$t('global.menu.entities.country')">Country</span>
              </b-dropdown-item>
                    <b-dropdown-item to="/entity/location" class="dropdown-item" v-on:click="collapseNavbar()">
                    <font-awesome-icon icon="asterisk" />
                    <span v-text="$t('global.menu.entities.location')">Location</span>
              </b-dropdown-item>
                    <b-dropdown-item to="/entity/department" class="dropdown-item" v-on:click="collapseNavbar()">
                    <font-awesome-icon icon="asterisk" />
                    <span v-text="$t('global.menu.entities.department')">Department</span>
              </b-dropdown-item>
                    <b-dropdown-item to="/entity/task" class="dropdown-item" v-on:click="collapseNavbar()">
                    <font-awesome-icon icon="asterisk" />
                    <span v-text="$t('global.menu.entities.task')">Task</span>
              </b-dropdown-item>
                    <b-dropdown-item to="/entity/employee" class="dropdown-item" v-on:click="collapseNavbar()">
                    <font-awesome-icon icon="asterisk" />
                    <span v-text="$t('global.menu.entities.employee')">Employee</span>
              </b-dropdown-item>
                    <b-dropdown-item to="/entity/job" class="dropdown-item" v-on:click="collapseNavbar()">
                    <font-awesome-icon icon="asterisk" />
                    <span v-text="$t('global.menu.entities.job')">Job</span>
              </b-dropdown-item>
                    <b-dropdown-item to="/entity/job-history" class="dropdown-item" v-on:click="collapseNavbar()">
                    <font-awesome-icon icon="asterisk" />
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item  to="/admin/jhi-metrics" v-on:click="collapseNavbar()">
                        <font-awesome-icon icon="tachometer-alt" />
                        <span v-text="$t('global.menu.admin.metrics')">Metrics</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/admin/jhi-health" v-on:click="collapseNavbar()">
                        <font-awesome-icon icon="heart" />
                        <span v-text="$t('global.menu.admin.health')">Health</span>
                    </b-dropdown-item>
                    <b-dropdown-item  to="/admin/jhi-configuration" v-on:click="collapseNavbar()">
                    ...
                    <b-dropdown-item v-if="!inProduction"  href='./h2-console' target="_tab" v-on:click="collapseNavbar()">
