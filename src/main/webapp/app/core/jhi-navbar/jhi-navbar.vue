    ...
    <b-navbar toggleable="md" type="dark" class="bg-primary">
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span v-text="$t('global.title')" class="navbar-title">Demo</span> <span class="navbar-version">{{version}}</span>
            </b-navbar-brand>
        </div>
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/entity/job">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.job')">Job</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/job-history">
                        <font-awesome-icon icon="asterisk" />
