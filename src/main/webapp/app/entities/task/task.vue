<template>
    <div>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="demoApp.task.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-task-heading" v-bind:title="$t('demoApp.task.delete.question')">Are you sure you want to delete this Task?</p>
            </div>
