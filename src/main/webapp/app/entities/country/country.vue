<template>
    <div>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="demoApp.country.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-country-heading" v-bind:title="$t('demoApp.country.delete.question')">Are you sure you want to delete this Country?</p>
            </div>
