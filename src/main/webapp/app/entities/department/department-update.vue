    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="demoApp.department.home.createOrEditLabel" v-text="$t('demoApp.department.home.createOrEditLabel')">Create or edit a Department</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('demoApp.department.departmentName')" for="department-departmentName">Department Name</label>
                        ...
                        <div class="form-group">
                            <label class="form-control-label" v-text="$t('demoApp.department.location')" for="department-location">Location</label>
                                <select class="form-control" id="department-location" name="location" v-model="department.location">
                                    ...
                                    <option v-bind:value="department.location && locationOption.id === department.location.id ? department.location : locationOption" v-for="locationOption in locations">{{locationOption.id}}</option>
                                </select>
                        </div>
