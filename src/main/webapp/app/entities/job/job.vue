<template>
    <div>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="demoApp.job.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-job-heading" v-bind:title="$t('demoApp.job.delete.question')">Are you sure you want to delete this Job?</p>
            </div>
